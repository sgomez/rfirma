...
| `isolated-store.sh` | Monta el perfil de usar y tirar que solo ve los tokens de SoftHSM y el envoltorio que lanza contra el al sujeto de la suite de conformidad, con el aislamiento que pide cada clase de sujeto; dice tambien con que raiz sirve el canal. |
