...
| `domain/protocol/parameters.rs` | Lo común a toda operación: las guardias de forma —versión mínima, fichero local y URL de servlet— y los dos indicadores del certificado pegado. Pruebas en `domain/protocol/parameters/tests.rs`. |
