...
fn the_signed_badge_is_written_by_the_postsign_and_by_nothing_else() {
    let writers = [
        ("signing/application/session.rs", production_half()),
        (
            "documents/application/recents.rs",
            half_of(include_str!("../../../documents/application/recents.rs")),
        ),
        (
            "site/application/session.rs",
            half_of(include_str!("../../../site/application/session.rs")),
        ),
        (
            "site/application/errand/mod.rs",
            half_of(include_str!("../../../site/application/errand/mod.rs")),
        ),
        (
            "site/application/errand/desk.rs",
            half_of(include_str!("../../../site/application/errand/desk.rs")),
        ),
        (
            "site/application/errand/replies.rs",
            half_of(include_str!("../../../site/application/errand/replies.rs")),
        ),
        (
            "site/application/errand/state.rs",
            half_of(include_str!("../../../site/application/errand/state.rs")),
        ),
        (
            "signing/application/policies.rs",
            half_of(include_str!("../policies.rs")),
        ),
        (
            "documents/application/documents.rs",
            half_of(include_str!("../../../documents/application/documents.rs")),
        ),
        (
            "documents/application/in_hand.rs",
            half_of(include_str!("../../../documents/application/in_hand.rs")),
        ),
        (
            "desktop/application/invocation.rs",
            half_of(include_str!("../../../desktop/application/invocation.rs")),
        ),
        (
            "signing/application/preview.rs",
            half_of(include_str!("../preview.rs")),
        ),
        ("lib.rs", half_of(include_str!("../../../lib.rs"))),
        (
            "site/adapters/window.rs",
            half_of(include_str!("../../../site/adapters/window.rs")),
        ),
    ];

    for (file, source) in writers {
        let written = source.matches("Badge::Signed").count();
        let expected = usize::from(file == "documents/application/recents.rs");
        assert_eq!(
            written, expected,
    ...
    let recents = half_of(include_str!("../../../documents/application/recents.rs"));
