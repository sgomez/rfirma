...
| `signing/SigningPanel.tsx` | 933 | El panel. El fichero más grande de la interfaz. |
...
| `viewer/DocumentViewer.tsx` | 919 | El visor y los tres gestos del recuadro. El botón de sellar vive en `signing/SigningPanel.tsx` desde #194. |
