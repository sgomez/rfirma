...
| `src/client.rs` | El cliente a prueba y qué cliente es: binario y un perfil aislado por almacén (`rsa`, `ec`, `token`, `several`, `expired`), cada uno con su envoltorio y su raíz de confianza, y el perfil de lanzamiento. |
