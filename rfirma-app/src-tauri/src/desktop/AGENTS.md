...
| `adapters/tauri.rs` | Las órdenes del escritorio: invocación, versión publicada, manejadores de `afirma://` y su elección, destino externo y estado. |
| `adapters/views.rs` | Lo que cruza a la ventana: manejadores de `afirma://`, versión nueva y señales de estado. Sin pruebas propias. |
