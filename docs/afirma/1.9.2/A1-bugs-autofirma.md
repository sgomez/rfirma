...
* **No observable:** la suite mide el protocolo, y si `::1` cuenta como origen local es cuestión de red: el cliente publicado llama siempre a `127.0.0.1` (`autoscript.js:1749`). El SAF_47 ante un origen fuera del bucle local lo mide `the_v4_channel_answers_saf_47_to_an_origin_that_is_not_loopback`.
