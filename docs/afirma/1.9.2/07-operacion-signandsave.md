...
| `SAF_14` | *Se necesita una versión más moderna de Autofirma...* | Reservado para `ParameterNeedsUpdatedVersionException`, que nadie lanza: no se emite ([15](15-errores.md) §4.7). | `ProtocolInvocationLauncher.java:618` |
