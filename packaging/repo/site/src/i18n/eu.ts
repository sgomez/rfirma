...
export const eu: Dictionary = {
  ...
  "how.step5.title": "Sinadura osatuta",
  "how.step5.body":
    "Sinatutako PDFa jatorrizkoaren ondoan gordetzen da. Laburpenak PAdES formatua eta dokumentuaren sinadura guztiak adierazten ditu.",

  "mock.aria": "rFirmaren leihoaren maketa, sinatzen ari dela",
  "mock.badge.signed": "Sinatuta",
  "mock.badge.unsigned": "Sinatu gabe",
  "mock.dropzone": "Arrastatu PDF bat edo sakatu irekitzeko",
  "mock.recents": "Azkenak",
  "mock.recent1.time": "gaur, 10:58",
  "mock.recent2.name": "Anexo-II-memoria.pdf",
  "mock.recent2.time": "gaur, 09:40",
  "mock.recent3.name": "Contrato-alquiler.pdf",
  "mock.recent3.time": "atzo, 17:20",
  ...
  "mock.file.meta": "27 orrialde · 2,4 MB",
  "mock.panel.certificate": "Ziurtagiria",
  "mock.panel.summary": "Laburpena",
  "mock.chooseCert": "Aukeratu ziurtagiria",
  "mock.cert.chosen.detail": "99999999R · AC FNMT Usuarios · Firefox",
  "mock.summary.format": "PAdES",
  "mock.summary.count": "2 sinadura",
  "mock.summary.mine": "Zurea",
  "mock.summary.sig1.detail": "99999999R · gaur, 11:04",
  "mock.summary.sig2.name": "SERVICIO DE GESTION TRIBUTARIA",
  "mock.summary.sig2.detail": "Q2800001A · 26/08/2026 09:12",
  "mock.visible.title": "Sinadura ikusgaia",
  "mock.visible.toggle": "Estanpatu sinadura-lauki bat dokumentuan",
  "mock.visible.hint.off": "Ziurtagiria aukeratzean aktibatzen da",
  "mock.visible.hint.on": "3. orrialdea · arrastatu kokatzeko",
  "mock.saveIn": "Hemen gordeko da",
  "mock.saveIn.dir": "…/Documentos/",
  "mock.action.sign": "Sinatu dokumentua",
  "mock.action.open": "Ireki PDFa",
  "mock.certlist.available": "Erabilgarriak",
  "mock.certlist.unusable": "Erabili ezinak",
  "mock.certlist.cert2.name": "GRACE HOPPER MURRAY",
  "mock.certlist.cert2.detail": "88888888T · AC Representación · rFirman instalatuta",
  "mock.certlist.cert3.name": "ALAN TURING MATHISON",
  "mock.certlist.cert3.detail": "77777777P · AC FNMT Usuarios · Chrome",
  "mock.certlist.cert3.state": "Errebokatuta 2026ko urtarrilaren 12an",
  "mock.pin.title": "Sartu PINa",
  "mock.pin.subject": "ADA LOVELACE BYRON · 99999999R",
  "mock.pin.label": "PINa",
  "mock.pin.cancel": "Utzi",
  "mock.pin.sign": "Sinatu",
  "mock.signing.title": "Dokumentua sinatzen…",
  "mock.signing.presign": "Sinadura prestatzen",
  "mock.signing.presign.note": "(aurresinadura)",
  "mock.signing.sign": "Sinatzen",
  "mock.signing.assemble": "PDFa muntatzen",
