...
| `ports.rs` | 83 | **Los tres puertos**: `Token` —listar, cómo pide el secreto, firmar e importar un `.p12`, con el listado de varios almacenes ya resuelto sobre el de uno—, `NssHost` y `CertificateMemory`. Ningún otro contexto los importa. |
