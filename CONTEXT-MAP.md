...
Las decisiones de la aplicación y del repositorio viven en `docs/adr/`; las que solo afectan a la
suite, en `rfirma-conformance/docs/adr/`, con la misma numeración.
