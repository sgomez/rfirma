...
Multi-context: `CONTEXT-MAP.md` en la raíz apunta a los dos glosarios —la aplicación en `CONTEXT.md` y la suite de conformidad en el suyo—; las decisiones, en `docs/adr/`, y las que solo afectan a la suite, en `rfirma-conformance/docs/adr/`, con la misma numeración. Ver `docs/agents/domain.md`.
