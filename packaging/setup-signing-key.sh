...
note "  ramas protegidas de antes ya no existe: hoy todo son rulesets."
...
printf '\n'
note "La publica NO se sube a mano: publish.yml la exporta de la huella y"
note "build-tree.sh la deja en la raiz del arbol, que es lo que Caddy sirve en"
note "/rfirma.asc (ADR-0015). Hasta la primera Release no hay arbol, asi que si"
note "la necesitas publicada antes, copia $PUBLICA a"
note "/srv/rfirma-repo/actual/rfirma.asc en el anfitrion."
